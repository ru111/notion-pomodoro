...
function countDown() {
  ...
  // Clock reaches 0:00
  if (time === '0') {
    changeBackground("#F8B9B8");
    sessionCount++;
    document.getElementById("sessionCount").innerHTML = sessionCount;
    if (sessionCount % 2 === 1) {
      // Break Time
      // document.body.className = "timerWorkEnd";
      // changeBackground("#99CEFB");
      ...
      // Task Time
      // changeBackground("#F8B9B8");
      // #document.body.className = "timerBreakEnd";
    ...
    function startTimer(session) {
      document.body.className = "timerOn";
      clearInterval(counter);
...
//Distraction count 
function countDistracted() {
  clicks += 1;
  document.getElementById("clicks").innerHTML = clicks;
};
function resetDistracted() {
  clicks = 0;
  document.getElementById("clicks").innerHTML = clicks;
}
